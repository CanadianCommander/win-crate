...
docker run -it --rm -p 22:22 -p 8080:80 -p 8443:443  ${DATA_MOUNTS} -v ./vm/disk/:/var/vm/disk/ -v ./vm/iso/:/var/vm/iso/ -v ./vm/ssh/rsa.key.pub:/root/.ssh/authorized_keys --privileged ghcr.io/canadiancommander/win-crate:latest /bin/bash
